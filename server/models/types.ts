...
import { IProductKey, IProductKeyDocument, IProductKeyModel } from "schemas/product-key/product-key.types";
...
export type InitDatabaseWithRawMethodOptions = {
  roleInput: string|Array<any>|Object;
  productKeyInput: string|Array<any>|Object;
  userInput: string|Array<any>|Object;
}
...
// ** overall
export type InitDatabaseOptions = InitDatabaseWithRawMethodOptions | InitDatabaseWithJsonMethodOptions | InitDatabaseWithRandomMethodOptions
