import { IProductKeyDocument, IProductKeyModel, ObjectOfFunctions, CheckIfStoredType } from "./product-key.types";
...
async function checkIfStored(this: IProductKeyModel, key:string|undefined): Promise<CheckIfStoredType> {
