...
export type UserTypeForJson<TInterface, PropertiesType> = Partial<
  UserInterfaceForJson<TInterface> & PropertiesType
>;
...
export interface IUserModel extends Model<IUserDocument>, BaseSchemaClass {
  ...
  findByEmail(this: IUserModel, email: string): Promise<IUserDocument | null>;
